...
if __name__ == "__main__":
    ...
    Important guidelines:
        ...
        - Format monetary values with 'NPR' and commas
    ...
    Leverage your expertise to deliver insights with depth and clarity. Do not provide large sentences except for recommendation.
